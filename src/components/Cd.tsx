    ...
    <section className="vinyles">
      <div className="firstRowVinyles">
        <div className="cdCard">
          <img src="/images/cd/aeCd.png" alt="Ae cd" className="cd" />
          <h3>After Effects</h3>
        </div>
        <div className="cdCard cdPhotoshop">
          <img src="/images/cd/figmaCd.png" alt="Photoshop cd" className="cd" />
          <h3>Figma</h3>
        </div>
        <div className="cdCard">
          <img src="/images/cd/blenderCd.png" alt="Blender cd" className="cd" />
          <h3>Blender</h3>
        </div>
        <div className="cdCard">
          <img
